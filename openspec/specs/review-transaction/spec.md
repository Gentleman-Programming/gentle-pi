...
- GIVEN Pi negotiates against the pinned v2.5.0-rc.3 provider
...
- GIVEN `.gentle-ai/` holds only pre-v2.5.0-rc.3 runtimes
- WHEN Pi resolves the pinned executable
- THEN negotiation fails hard, naming the expected v2.5.0-rc.3 version, rather than degrading to an older runtime
