...
- GIVEN Pi negotiates against the pinned v2.7.0 provider
...
- GIVEN `.gentle-ai/` holds only pre-v2.7.0 runtimes
- WHEN Pi resolves the pinned executable
- THEN negotiation fails hard, naming the expected v2.7.0 version, rather than degrading to an older runtime
