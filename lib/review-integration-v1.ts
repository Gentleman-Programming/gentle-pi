...
const SCHEMA_SUCCESSORS_FROM_MINOR_3: Readonly<Record<string, string>> = Object.freeze({
...
const NEXT_TRANSITION_OPERATIONS = ["review.start", "review.finalize", "review.recover", "review.repair", "review.retry_final_verification", "review.validate"] as const;
...
function requireVersionedIdentity(value: Record<string, unknown>, base: string, operation: string): 1 | 2 {
...
export function decodeReviewStartV1(value: unknown): ReviewStartV1 {
	...
	const v2Fields = ["artifact_subjects", "changed_path_manifest", "candidate_diff", "repository_context"] as const;
