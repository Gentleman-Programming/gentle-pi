...
const REVIEW_INTEGRATION_SCHEMA_CAPABILITIES_V2 = "gentle-ai.review-integration.capabilities/v2" as const;
const REVIEW_INTEGRATION_SCHEMA_CAPABILITIES_V2_2 = "gentle-ai.review-integration.capabilities/v2.2" as const;
const REVIEW_INTEGRATION_SCHEMA_STATUS_V3 = "gentle-ai.review-integration.status/v3" as const;
const REVIEW_INTEGRATION_SCHEMA_STATUS_V5 = "gentle-ai.review-integration.status/v5" as const;
const REVIEW_INTEGRATION_SCHEMA_CONSENT_V2 = "gentle-ai.review-integration.consent/v2" as const;
const REVIEW_INTEGRATION_SCHEMA_CONSENT_V3 = "gentle-ai.review-integration.consent/v3" as const;
...
const MIXED_MANIFEST_2_2_MARKERS: readonly string[] = Object.freeze([REVIEW_INTEGRATION_SCHEMA_CAPABILITIES_V2, REVIEW_INTEGRATION_SCHEMA_STATUS_V3, REVIEW_INTEGRATION_SCHEMA_CONSENT_V2]);
...
function decodeProtocol(value: Record<string, unknown>, label: string): 0 | 2 {
	...
	return protocol.minor as 0 | 2;
}

function disallowMixedManifestSchemas(advertisedSchemas: readonly string[], protocolMinor: 0 | 2, label: string): void {
