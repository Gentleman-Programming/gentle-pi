...
function harness(options: { maxConcurrency?: number; answer?: Record<string, unknown>; exitOnKill?: boolean; onSuccessfulMutation?: RunnerHooks["onSuccessfulMutation"] } = {}): Harness {
