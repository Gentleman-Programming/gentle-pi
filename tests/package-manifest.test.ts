...
test("v2.0.0 release package and runtime stop before publication", () => {
	const packageJson = readPackageJson();
	assert.equal(packageJson.version, "2.0.0", "the release manifest must remain explicitly pinned to v2.0.0");
	assert.equal(
