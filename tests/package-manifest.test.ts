...
test("package verification binds the published Gentle AI v2.2.0 runtime pin", () => {
	...
	assert.match(installer, /INSTALLER_VERSION = "2\.2\.0"/);
	assert.match(binary, /GENTLE_AI_VERSION = "2\.2\.0"/);
	assert.match(verifier, /v2\.2\.0/);
});
