 ...
 * throwing.
 */
export function decodeTelemetryTriggerDecision(stdout        )                                         {
	let parsed         ;
	try {
	...
	if (!(TELEMETRY_TRIGGER_DECISIONS                     ).includes(record.decision)) return undefined;
...
function telemetryKillSwitchReason(env                                              )                                        {
 ...
 */
export function shouldTriggerTelemetry(env                                              )          {
 ...
 */
export function spawnTelemetryTrigger(options                              )                         {
